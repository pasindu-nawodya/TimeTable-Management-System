...
import static Timetable.Management.System.RoomForLecturer.sList2;
 ...
 * @author LENOVO
 */
public class RoomForSubject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        selectSubjectCombo = new javax.swing.JComboBox<>();
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/roomsubject.jpg"))); // NOI18N
        ...
        selectSubjectCombo.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(selectSubjectCombo, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(selectSubjectCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(64, 64, 64)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private Connection DoConnect(){
        ...
        try{
            ...
            Logger.getLogger(RoomForSubject.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void currentSubjects(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                selectSubjectCombo.addItem(String.format("%s | %s",rs.getString(5),rs.getString(4)));      // SET THE FORMAT
            }
        }catch (SQLException ex){
            Logger.getLogger(RoomForSubject.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void selectRoomSaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectRoomSaveBtnActionPerformed
        ...
        Connection conn = DoConnect();
        try{
            insert = conn.prepareStatement("INSERT INTO room_for_subject (subject,room) VALUES (?,?)");
            insert.setString(1,selectSubjectCombo.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoomForSubject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> selectSubjectCombo;
