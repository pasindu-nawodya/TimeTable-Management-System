...
import static Timetable.Management.System.RoomForSubject.sList;
import static Timetable.Management.System.RoomForSubject.sList2;
 ...
 * @author LENOVO
 */
public class RoomForGroup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        selectGroupCombo = new javax.swing.JComboBox<>();
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/roomgroup.jpg"))); // NOI18N
        ...
        selectGroupCombo.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(selectGroupCombo, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(selectGroupCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(64, 64, 64)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private Connection DoConnect(){
        ...
        try{
            ...
            Logger.getLogger(RoomForGroup.class.getName()).log(Level.SEVERE, null, ex);
   ...
   private void currentGroups(){
        
        Connection conn = DoConnect();
        
        try{
            ResultSet rs = conn.createStatement().executeQuery("SELECT * FROM groupids UNION SELECT * FROM subgroupids ");
            while(rs.next()){
                sList2.add(rs.getString(1));
                selectGroupCombo.addItem(String.format("%s",rs.getString(2))); 
            }
        }catch (SQLException ex){
            Logger.getLogger(RoomForGroup.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void selectRoomSaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectRoomSaveBtnActionPerformed
        ...
        Connection conn = DoConnect();
        try{
            insert = conn.prepareStatement("INSERT INTO room_for_groups (student_group,room) VALUES (?,?)");
            insert.setString(1,selectGroupCombo.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoomForGroup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> selectGroupCombo;
